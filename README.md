...
- I just need to fit hparams for each scenario, then run with N trials
- Can we detect whether we should just give up early depending on how a game has gone so far?